...
public interface MatchRepository extends JpaRepository<Match, MatchId>, MatchRepositoryCustom {
    ...
    List<Match> findByDateOrderByChampionshipIdAscHomeTeamNameAsc(LocalDateTime date);

    // Find matches by championship and date
    List<Match> findByChampionshipAndDateOrderByHomeTeamNameAsc(Championship championship, LocalDateTime date);
}